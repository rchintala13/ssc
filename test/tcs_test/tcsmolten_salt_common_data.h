...
void tcsmolten_salt_default(ssc_data_t &data)
{
    ...
    ssc_data_set_number(data, "gross_net_conversion_factor", 0.9);
    ...
    ssc_data_set_number(data, "c_atm_0", 0.006789);
    ...
    ssc_data_set_number(data, "opt_init_step", 0.06);
    ...
    ssc_data_set_number(data, "design_eff", 0.412);
    ssc_data_set_number(data, "tshours", 10);
    ssc_data_set_number(data, "solarm", 2.4);
    ...
    ssc_data_set_number(data, "eta_c", 0.89);
    ssc_data_set_number(data, "eta_t", 0.9);
    ssc_data_set_number(data, "recup_eff_max", 0.96);
    ...
    ssc_data_set_number(data, "sco2ud_T_htf_cold_calc", 10e+37);
    ...
    ssc_data_set_number(data, "_sco2_P_high_limit", 10e+37);
    ssc_data_set_number(data, "_sco2_P_ref", 10e+37);
    ssc_data_set_number(data, "_sco2_T_amb_des", 10e+37);
    ssc_data_set_number(data, "_sco2_T_approach", 10e+37);
    ssc_data_set_number(data, "_sco2_T_htf_hot_des", 10e+37);
    ssc_data_set_number(data, "_sco2_deltaT_PHX", 10e+37);
    ssc_data_set_number(data, "_sco2_design_eff", 10e+37);
    ssc_data_set_number(data, "_sco2_eta_c", 10e+37);
    ssc_data_set_number(data, "_sco2_eta_t", 10e+37);
    ssc_data_set_number(data, "_sco2_recup_eff_max", 10e+37);
    ...
    ssc_data_set_number(data, "disp_time_weighting", 0.99);
    ssc_data_set_number(data, "disp_rsu_cost", 950);
    ssc_data_set_number(data, "disp_csu_cost", 10000);
    ssc_data_set_number(data, "disp_pen_delta_w", 0.1);
    ...
    ssc_data_set_number(data, "dispatch_factor1", 2.064);
    ssc_data_set_number(data, "dispatch_factor2", 1.2);
    ssc_data_set_number(data, "dispatch_factor3", 1);
    ssc_data_set_number(data, "dispatch_factor4", 1.1);
    ssc_data_set_number(data, "dispatch_factor5", 0.8);
    ssc_data_set_number(data, "dispatch_factor6", 0.7);
    ...
    ssc_data_set_number(data, "rec_height", 21.6029);
    ssc_data_set_number(data, "D_rec", 17.65);
