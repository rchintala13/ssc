#ifndef _CMOD_UTILITYRATE5_TEST_H_
#define _CMOD_UTILITYRATE5_TEST_H_
...
/**
 * CMUtilityRate5 tests the cmod_utilityrate5 using the SAM code generator to generate data
 */
class CMUtilityRate5 : public ::testing::Test {
