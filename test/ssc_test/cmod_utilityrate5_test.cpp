...
*/
TEST_F(CMUtilityRate5, TestNEMOptions)
{
	rate1(data);
	const char * SSCDIR = std::getenv("SSCDIR");
	char gen[500], load[500];
...
/*
Test backwards compatibility with Utilityrate6 
*/
TEST_F(CMUtilityRate5, TestRate1_UtilityRate6)
{
	rate1(data);
	ssc_data_set_number(data, "use_urdb_json", 0);
	const char * SSCDIR = std::getenv("SSCDIR");
	char gen[500], load[500];
	double ec_wo_sys_array[6] = { 2326, 111909, 1008785, 2326, 111909, 1008785 };
	double ec_w_sys_array[6] = { 1312, 109862, 1006718, -8094, 80241, 967965 };
...
Test rate 4 with all NEM options 1 across 1 combinations
*/
TEST_F(CMUtilityRate5, TestNEMOptions_UtilityRate6)
{
	rate1(data);
	ssc_data_set_number(data, "use_urdb_json", 0);
	const char * SSCDIR = std::getenv("SSCDIR");
